...
class Softmax(Layer):
  ...
  def call(self, inputs, mask=None):
    ...
    if isinstance(self.axis, (tuple, list)):
      if len(self.axis) > 1:
        computed_out =  math_ops.exp(inputs - math_ops.reduce_logsumexp(
            inputs, axis=self.axis, keepdims=True))
      else:
        computed_out =  K.softmax(inputs, axis=self.axis[0])
    else:
      computed_out =  K.softmax(inputs, axis=self.axis)

    #print("masking .................................................")
    #Force masking the future
    if mask is not None:
      return computed_out*mask
    else:
      return computed_out
